...
export const SOCIAL_MEDIA: SocialMediaProps[] = [
  {
    ...
    name: "gmail",
    href: "mailto:khensin166@gmail.com",
  ...
  },
  {
    ...
    name: "tiktok",
    href: "https://www.tiktok.com/@kenantomfiebukit989",
  ...
  },
  {
    ...
    description: "Subscribe to my YouTube channel for more video content.",
    name: "youtube",
    href: "https://www.youtube.com/@kenantomfiebukit989",
    icon: <YoutubeIcon size={iconSize} />,
    backgroundIcon: <YoutubeIcon size={backgroundIconSize} />,
    textColor: "text-red-100",
    backgroundColor: "bg-red-500",
    borderColor: "border-red-500",
    backgroundGradientColor: "bg-gradient-to-b from-red-600 to-red-800",
    isShow: true,
  },
  {
