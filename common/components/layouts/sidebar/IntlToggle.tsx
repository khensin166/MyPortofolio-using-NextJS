...
const IntlToggle = () => {
  ...
  return (
    <div className="flex items-center justify-center">
      <div
        className={`relative hidden items-center gap-1 rounded-full border border-border bg-secondary p-1 shadow-inner lg:flex ${
        ...
        {locales.map((locale, index) => (
          ...
          >
            <motion.div
              ...
              animate={{
                color: currentIndex === index ? "hsl(var(--primary-foreground))" : "hsl(var(--muted-foreground))",
              }}
      ...
      <button
        className="flex items-center gap-2 rounded-full border border-border bg-secondary p-1 transition duration-200 hover:scale-110 lg:hidden"
        onClick={() =>
