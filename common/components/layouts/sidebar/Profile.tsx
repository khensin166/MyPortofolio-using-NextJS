...
const Profile = () => {
  ...
  return (
    <div
      className={clsx(
        "fixed z-20 w-full bg-background p-5 shadow-sm dark:border-b border-border dark:bg-card lg:relative lg:border-none lg:!bg-transparent lg:p-0 xl:shadow-none",
        isOpen && "pb-0",
      )}
    >
