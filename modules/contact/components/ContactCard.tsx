...
const ContactCard = ({
  ...
  return (
    <SpotlightCard
      className={`relative grid w-full grid-cols-[2.5fr_1fr] overflow-hidden rounded-md border-2 border-border p-6 ${colSpan} ${backgroundGradientColor}`}
    >
      <div className="absolute -left-[3.5rem] -top-[3.5rem] rotate-45 text-foreground/5 transition-colors duration-300">
        {backgroundIcon}
      </div>
      <div
      ...
      >
        ...
        >
          <Link
            ...
            data-posthog-event={`click_contact_${name}`}
          >
