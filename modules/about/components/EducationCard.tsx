    ...
    <SpotlightCard className="flex items-start gap-5 p-6">
      {logo ? (
        <Image 
          ...
          src={logo} 
          alt={school} 
          className="shrink-0 aspect-square object-contain rounded-lg border-[1.5px] border-neutral-300 bg-neutral-100 dark:border-neutral-700"
        />
      ) : (
        <CompanyIcon size={65} className="shrink-0 text-neutral-500" />
      )}
