...
const InputSearch = () => {
  ...
  return (
    <div className="flex w-full items-center gap-2 rounded-lg bg-secondary p-2 outline outline-border focus-within:outline-primary transition-all duration-300 md:w-fit">
